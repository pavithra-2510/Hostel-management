...
?>
	<center><h2 style="color: darkblue;background-color: white;border:none;">Girls Hostels</h2></center>
	...
	<div class="tablecontent">
		       ...
		       $conn = new mysqli("sql212.epizy.com","epiz_26261548","ltM63SCaag","epiz_26261548_hostel");
				...
				$sql = "SELECT * FROM residentdetails rd, resident r WHERE rd.EmailId=r.Email_Id AND r.Gender='Female' ";
